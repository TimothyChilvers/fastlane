    ...
    def self.plain_options
      [
        ...
        FastlaneCore::ConfigItem.new(key: :export_method,
                                     ...
                                     description: "Method used to export the archive. Valid values are: app-store-connect, validation, ad-hoc, package, enterprise, development, developer-id and mac-application",
                                     type: String,
                                     optional: true,
                                     verify_block: proc do |value|
                                       av = %w(app-store-connect validation ad-hoc package enterprise development developer-id mac-application)
